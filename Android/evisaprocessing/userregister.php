...
if($connect)
{
				...
				$sqlCheckUname = mysql_query("SELECT * FROM userregister WHERE username LIKE '$email'");
				...
				else
				{
					...
					$sql_register = mysql_query("INSERT INTO userregister VALUES ('','$ename','$email','$eemail','$econtact','$gender','$edob','$epassword')");
