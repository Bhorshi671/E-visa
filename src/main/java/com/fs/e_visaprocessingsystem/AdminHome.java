    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.button:
                ...
                startActivity(new Intent(getApplicationContext(), ExecutiveRegister.class));
                // Toast.makeText(this, "Add Products", Toast.LENGTH_SHORT).show();
                break;


            case R.id.button3:
                startActivity(new Intent(getApplicationContext(), ViewUserDetails.class));
                // Toast.makeText(this, "View Products", Toast.LENGTH_SHORT).show();
                break;

            case R.id.button4:
                Intent ii= new Intent(getApplicationContext(),ViewExecutive.class);
                startActivity(ii);
                break;
