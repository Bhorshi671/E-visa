...
public class UserRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(UserRegister.this,
        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        ||ddob.equals("")||dpwd.equals(""))
                {
                    ...
                    if (checkedId == -1) {
                        Toast.makeText(UserRegister.this, "Select gender please", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    public class registeration extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur="http://"+ServerConnect.serverip+"/Android/evisaprocessing/userregister.php?pname="+ URLEncoder.encode(dname)
