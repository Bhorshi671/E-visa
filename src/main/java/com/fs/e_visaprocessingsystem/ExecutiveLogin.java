...
public class ExecutiveLogin extends AppCompatActivity {
    Button dl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_executive_login);
    ...
    public class dlogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ExecutiveLogin.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur = "http://"+ServerConnect.serverip +"/Android/evisaprocessing/executivelogin.php?eusername="+eusername
                        +"&epassword="+epassword;
                Log.i("URL", ur);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (file_url.trim().equals("Success")) {
                ...
                Intent in = new Intent(ExecutiveLogin.this, ExecutiveHome.class);
